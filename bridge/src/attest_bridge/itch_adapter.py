"""itch.io adapter: a claim-queue poller, not a webhook (task-9-brief.md;
OI-4, source-verified 2026-07-24 — `docs/superpowers/plans/2026-07-24-p2.1-
webhook-bridge.md`).
...
class ItchPoller:
    ...
    def tick(self, *, now: datetime) -> None:
        ...
        Pinned per task-9-brief.md — see the module/class docstrings for why
